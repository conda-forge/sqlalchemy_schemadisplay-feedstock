About sqlalchemy_schemadisplay-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sqlalchemy_schemadisplay-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sqlalchemy_schemadisplay-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sqlalchemy_schemadisplay
# for installing globally
pixi global install sqlalchemy_schemadisplay
```
...
It is possible to list all of the versions of `sqlalchemy_schemadisplay` available on your platform:
...
```
pixi search sqlalchemy_schemadisplay --channel conda-forge
```
